...
1. `./parsers_legacy.py`
2. `./parsers_migrated.py`
3. `./benchmarks/__init__.py`
4. `./benchmarks/parser_performance.py`
5. `./tests/migration/__init__.py`
6. `./tests/migration/test_baseline.py`
7. `./PHASE_3.1_COMPLETION_REPORT.md`

### 新建目录 (5个)

1. `./tests/migration/`
2. `./tests/migration/baselines/`
3. `./benchmarks/`
4. `./parsers/templates/sites/wechat/`
5. `./parsers/templates/sites/xiaohongshu/`

### 生成的数据文件 (3个)

1. `./tests/migration/baselines/wechat_baseline.json`
2. `./tests/migration/baselines/xhs_baseline.json`
3. `./tests/migration/baselines/generic_baseline.json`

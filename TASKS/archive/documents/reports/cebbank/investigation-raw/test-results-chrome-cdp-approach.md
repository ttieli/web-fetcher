...
**Script**: `./test_chrome_cdp_connection.py`
...
**Script**: `./test_chrome_cdp_ssl_bypass.py`
...
**Script**: `./test_chrome_cdp_simple.py`
...
**Script**: `./test_manual_chrome_check.py`
...
### Scripts Created
1. `./test_chrome_cdp_connection.py`
2. `./test_chrome_cdp_ssl_bypass.py`
3. `./test_chrome_cdp_simple.py`
4. `./test_manual_chrome_check.py`

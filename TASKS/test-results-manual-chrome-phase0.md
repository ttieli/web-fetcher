...
**Details**:
- Expected path: `./config/chrome-debug-launcher.sh`
...
- Error message:
  ...
  <HOME>/.../config/chrome-debug-launcher.sh
  ```
...
ERROR:root:Chrome launcher script not found: ./config/chrome-debug-launcher.sh
